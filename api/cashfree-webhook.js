export default async function handler(req, res) {
  ...
  try {
    ...
    if (paymentStatus === 'SUCCESS' || paymentStatus === 'PAID') {
      ...
      // 1. Update Supabase Order Status to 'paid' and get order representation
      ...
      // Fallback: If PATCH representation didn't return order, query Supabase directly
      if (!updatedOrder) {
      ...
      if (updatedOrder && updatedOrder.email) {
        // Derive plan_type ('normal' or 'normal_addon')
        ...
        // Build Customer Email Content based on plan_type
        ...
        // 2a. Send Customer Delivery Email
        try {
        ...
        // 2b. Send Admin Notification Email (xtechmax2024@gmail.com) with plan_type
